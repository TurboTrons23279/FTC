...
@Autonomous(name = "Red 2 Autonomous Sample 2024-2025")
public class Red2AutoSampleDrop extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            driveFunction(DRIVE_SPEED,-15,15,15,-15); // six inches right
